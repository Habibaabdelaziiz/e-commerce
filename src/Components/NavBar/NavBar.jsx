...
import { CounterContext } from "../../Conttext/CounterContext.jsx";
import { UserContext } from "../../Conttext/UserContext.jsx";
              ...
              <li className="relative">
                <NavLink to="Cart">
                  <img
                    ...
                    alt="E-commerce Logo"
                  />
                  <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-green-500 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">
                    {cartDetailse?.numOfCartItems}
                  </div>
                </NavLink>
              </li>
              {token && (
                <li>
                  <span
                    to="logout"
                    onClick={LogOut}
                    className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 cursor-pointer md:hover:bg-transparent md:border-0 md:hover:text-green-700 md:p-0 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                  >
                    LogOut
                  </span>
                </li>
